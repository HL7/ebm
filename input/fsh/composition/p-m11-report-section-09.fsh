...
* section[adverseEvents]
  ...
  * section[definitions]
    ...
    * section[productComplaintsDefinitions]
      * text 1..1
      * text ^comment = "Specify the definitions of product complaints in the context of the trial. If appropriate, include 9.1.3.1 Definition of Medical Device Product Complaints."
