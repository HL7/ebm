...
The **[PICOTaggedEvidence Profile][PICOTaggedEvidence]** is used to classify the Evidence with respect to a clinical question defined with Population, Intervention, Comparator, and Outcome components.
