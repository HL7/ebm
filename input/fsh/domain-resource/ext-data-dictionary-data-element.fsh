...
* extension contains id 0..1 and label 0..1 and description 0..1 and classifier 0..* and definition 1..1 and datatype 0..* and constraint 0..* and missingDataMeaning 0..1 and unacceptableDataHandling 0..*
