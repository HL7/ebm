...
Id: m11-section-09
Description: "Profile of Composition for Evidence Based Medicine IG. The M11Section09 Profile is used for summary of Section 9 Statistical Considerations for the International Council for Harmonisation of Technical Requirements for Pharmaceuticals for Human Use (ICH) Clinical Electronic Structured Harmonised Protocol (CeSHarP) M11 Technical Specification."
* category 1..*
