...
In the latest version of FHIR R6 (with build version since November 2025), the determinedBy[x] element is replaced with 2 elements:  formula 0..1 Expression datatype, and determiner 0..1 Reference datatype with resource types of <b>Practitoner</b>, <b>PractitionerRole</b>, <b>Organization</b>, <b>Device</b>, or <b>DeviceDefinition</b>
