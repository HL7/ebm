...
* identifier ^definition = "A formal identifier that is used to identify this Classification when it is represented in other formats, or referenced in a specification, model, design or an instance."
* workflowStatus 0..0
* disposition 0..0