...
Description: "Resource (FHIR or non-FHIR) associated with the Resource, plus specification of a portion quoted from the Resource."
...
* extension contains type 1..1 and quotation 1..1 and targetUri 0..1 and targetReference 0..1 and targetCanonical 0..1 and targetAttachment 0..1 and targetMarkdown 0..1
...
* extension[quotation].value[x] only markdown
  * ^short = "The quoted portion of the related artifact"
  * ^definition = "The quoted portion of the artifact that is related to this Resource."
