...
Id: m11-section-12
Description: "Profile of Composition for Evidence Based Medicine IG. The M11Section12 Profile is used for summary of Section 12 Appendix: Adverse Events and Serious Adverse Events -- Definitions, Severity, and Causality for the Interntaional Council for Harmonisation of Technical Requirements for Pharmaceuticals for Human Use (ICH) Clinical Electronic Structured Harmonised Protocol (CeSHarP) M11 Technical Specification."
* category 1..*
