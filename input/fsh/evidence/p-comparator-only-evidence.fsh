...
Description: "Profile of Evidence for Evidence Based Medicine IG. The ComparatorOnlyEvidence Profile is used for evidence with a measured variable that is considered the outcome of an exposure or intervention, and an exposure with a categorical value that is the reference category for the exposure (in a ComparativeEvidence Profile). The ComparatorOnlyEvidence describes the evidence for the comparator group." 
* useContext 1..*
