...
The EvidenceAssessment Profile was added to include a content slice for the rating system. The CertaintyOfEvidence and RiskOfBias Profiles were changed to use EvidenceAssessment as the base. The RecommendationRating Profile was added using a base of EvidenceAssessment. The RecommendationJustification Profile was modified to use a base of RecommendationRating.
